...
public class SeatService {
    ...
    public Seat addSeat(SeatRequest seatRequest) {
        ...
        PCRoom pcRoom = pcRoomRepository.findByName(seatRequest.getPcRoomName()).orElseThrow(() -> new SuperException(CustomExceptionType.PCROOM_NOT_FOUND_EXCEPTION));
        ...
        return seatRepository.findByPcRoom_NameAndAndSeatName(seatRequest.getPcRoomName(), seatRequest.getSeatName());
    }
